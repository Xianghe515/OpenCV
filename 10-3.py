    ...
    for output in output3:
        for vec85 in output:
            ...
            if confidence>0.5:   # 신뢰도가 50% 이상인 경우만 취함
                ...
                box.append([x,y,x+w,y+h])       # 박스 정보
                conf.append(float(confidence))  # 신뢰도
                id.append(class_id)             # 클래스 id
...
colors = np.random.uniform(0,255, size=(100,3))        # 100개 색으로 트랙을 구분 

# SORT 논문에 내용이 구현된 sort.py를 불러옴.... 
